...
const RetreatsCards = () => {
    ...
    return (
        <div className='grid lg:grid-cols-2 items-center mt-14 justify-center '>
            {
                retreatsData.map((card, index) => {
                    return (
                        <div key={index} className={`justify-center p-8 h-full w-full border-[0.1px] flex lg:flex-row flex-col ${index % 2 === 0 ? 'border-l-0 border-white/20 border-r-0' : ''} ${index % 2 != 0 ? 'border-r-0 border-white/20 b' : ''} border-white/20`}>
