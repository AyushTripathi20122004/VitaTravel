            ...
            <div className='grid lg:order-2 md:order-1 order-1 lg:grid-rows-2 justify-between border-[0.1px] border-white/20 border-l-0 border-r-0   '>
                <div className=" z-10 py-7 flex flex-col  lg:h-1/2 h-fit gap-4 px-5  w-full ">
                    ...
                    <div className=' items-center h-fit border-white/40 flex justify-start  gap-2 hover:text-orange-500 '>
                        <svg class="PracCoach" width="15" height="15" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <h1 className='text-nowrap text-white text-xs font-semibold'>Practitioners & Coaches</h1>
                    </div>
                    <div className="paragraph-field ">
                        <h1 className='text-white lg:text-5xl text-4xl font-semibold w-xl'>
                            The 200+ faces <br />
                            behind Vita Travel
                        </h1>
                    </div>
                ...
                <div className='flex lg:flex-row md:flex-row flex-col lg:gap-0 gap-10 lg:items-end px-5 text-white pb-7 '>
                    <div className='flex flex-col w-1/2 h-full justify-between'>
                        <PlusIcon />
                        <div>
                            <h1>Your Retreat, Our Experts</h1>
                            <p className='text-sm text-white/40'>Each coach is carefully selected to <br />
                                deliver the highest quality guidance <br />
                                in yoga, meditation, fitness, and <br />
                                holistic well-being.
                            </p>
                        </div>
                    </div>
