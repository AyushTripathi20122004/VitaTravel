...
import OurCoachesCards from './OurCoachesCards'
...
const OurCoaches = () => {
    return (
        <div className=' bg-[#091B20]'>
            <div>
                <div className="flex lg:flex-row md:flex-row flex-col z-10 py-20 lg:gap-40 gap-10 px-10  w-full ">
                    {/* logo of retreat */}
                    <div className=' coaches-logo items-center h-fit border-white/40  flex justify-start  gap-2 hover:text-orange-500 '>
                    ...
                    <div className="Coaches-Hero-Text text-white">
                        <h1 className='text-5xl font-semibold mb-5 tracking-tighter'>Our coaches</h1>
                        <p className='text-lg font-medium tracking-tighter text-white/40 lg:w-sm'>
                            Our fully remote lives, travels, and works all over the world.
                            From India to Indonesia, the Philippines to Portugal, Ukraine to
                            the US; and everywhere else in between.
                        </p>
                    </div>
                </div>
                {/* our coaches cards seciton here */}
                <OurCoachesCards />
                {/* our values card section here */}
                <OurValuesCard />
            </div>
        </div>
    )
