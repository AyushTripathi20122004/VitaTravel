...
const Intro = () => {
  return (
    <div className='relative w-full  lg:h-[119vh] h-[100vh] lg:overflow-none overflow-hidden   leading-[1]'>
      ...
      <h1 className="absolute tracking-tighter top-[40%] lg:top-[43%] left-1/2 -translate-x-1/2 -translate-y-1/2 z-0 text-[10rem] font-[600] text-white">
        Travel
      </h1>

      {/* Content Above Image */}
      <div className="absolute lg:top-[60%] top-[55%] left-1/2 -translate-x-1/2 -translate-y-1/2 z-30  flex flex-col justify-between items-center">
