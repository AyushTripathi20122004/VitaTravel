        ...
        <div className='bg-[#091B20] py-20 '>
            <div className="flex lg:flex-row flex-col z-10 py-10 lg:gap-40 gap-10 px-5  w-full ">
                ...
                <div className="paragraph-field ">
                    <p className='text-white lg:text-5xl text-4xl w-full  font-semibold lg:w-2xl'>
                        Not just trips experiences that
            ...
            <div className="flex lg:flex-row flex-col gap-5 px-5  py-10">
                ...
                <div className='flex flex-col justify-between '>
                    <div className=" flex flex-col">
                        <div className="paragraph-field">
                            <p className="text-white   lg:text-[16px] text-xl tracking-wider lg:w-[70%] w-full  font-medium">
                                <span className='ml-10'>Vita Travel is a premium wellness travel marketplace
                                    that </span>
                                <span>
                    ...
                    <div className='flex h-full items-end lg:mt-0 mt-20'>
